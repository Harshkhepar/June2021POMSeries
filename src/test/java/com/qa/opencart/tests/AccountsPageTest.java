...
public class AccountsPageTest extends BaseTest {
	...
	public void accPageSetup() {
		...
		// loginPage ref is inherited from Base class  
		// now with this method when i run AccountPageTest class in TestNg first Base class @BeforeTest run 
		// and give login class reference and the moment we get Login class ref we login into the Account class
	}
	...
	public void searchTest(String productName) { // productName is the holding parameter for getSearchData DataProvider
		// resultsPage = accPage.doSearch("Macbook Pro");
		...
		//Assert.assertTrue(resultHeader.contains("Macbook Pro"));
