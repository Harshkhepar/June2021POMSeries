...
// loginPageTest class should interact with LoginPage class
	// i should never use driver in Test class
	...
	public void loginTest() {
		...
		Assert.assertTrue(accPage.isLogoutLinkExist());// to validate that login is done or not
	}
